...
Based on the definition~\autoref{def:cs_system} alone, it is already clear that crowdsourcing as a task-solving approach has not only benefits, when compared with expert-based approach, but a number of issues and challenges as well.
...
Allowing a community or even the whole population to contribute to content creation improves its quality due to continuous iterational development, improvement and updating of the content.
